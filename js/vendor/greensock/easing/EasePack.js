...
(window._gsQueue || (window._gsQueue = [])).push( function() {
	...
	window._gsDefine("easing.Back", ["easing.Ease"], function(Ease) {
		...
		var w = (window.GreenSockGlobals || window),
			...
			_easeReg = Ease.register || function(){}, //put an empty function in place just as a safety measure in case someone loads an OLD version of TweenMax.js where Ease.register doesn't exist.
