...
(function() {
    var backboneSuper = function(Backbone) {
        ...
        var unImplementedSuper = function(context, method) {
            console.log('### ', context);
                    ...
                    if (typeof protoProps[name] == "function" && fnTest.test(protoProps[name])) {
                        child.prototype[name] = (function(name, fn) {
                            var wrapper = function() {
                                ...
                                this._super = _super[name] || unImplementedSuper(_super, name);
    ...
    if (typeof define === 'function' && define.amd) {
        define('backbone.super', ['backbone'], function(Backbone) {
            return backboneSuper(Backbone);
        });
    }
    else {
